  ...
  return (
    <>
      <div className="tarjeta">
        <div>
          <img className="tarjeta-img-inside" src={FotoSala} alt={NombreSala} />
        </div>
  ...
  const cancelarReservacion = async (reservacionId) => {
    try {
      const response = await fetch(
        `https://dreamlabapidev.azurewebsites.net/api/rechazar_reservacion_estudiante?reservacionId=${reservacionId}`,
        {
          method: "DELETE",
        }
      );
